...
A preprint of this paper is available on arXiv.
> [Y. Xia](https://yuchenxia.com), D. Dittler, N. Jazdi, H. Chen and M. Weyrich, **LLM experiments with simulation: Large Language Model Multi-Agent System for Process Simulation Parametrization in Digital Twins**, 2024, arXiv preprint, https://doi.org/10.48550/arXiv.2405.18092.

## About the Author
<a href="https://yuchenxia.com" target="_blank">Yuchen Xia, Ph.D.</a> specializes in LLM agents, digital twins, and industrial automation since 2021. You can find more about his work, publications and projects on his <a href="https://yuchenxia.com" target="_blank">personal website</a>.
